...
"}")
        ...
        self.categories_total_comboBox = QComboBox(self.widget_8)
        self.categories_total_comboBox.addItem("")
        self.categories_total_comboBox.addItem("")
        self.categories_total_comboBox.setObjectName(u"categories_total_comboBox")
        self.categories_total_comboBox.setMinimumSize(QSize(100, 0))
        self.categories_total_comboBox.setMaximumSize(QSize(50, 16777215))

        self.verticalLayout_11.addWidget(self.categories_total_comboBox, 0, Qt.AlignLeft)
        ...
        self.frame_8.setGeometry(QRect(11, 11, 423, 41))
        font3 = QFont()
        ...
        self.label_6.setGeometry(QRect(20, 0, 117, 24))
        self.label_6.setFont(font3)
        self.scrollArea_7 = QScrollArea(self.Notification_widdget)
        self.scrollArea_7.setObjectName(u"scrollArea_7")
        self.scrollArea_7.setGeometry(QRect(20, 40, 411, 151))
        self.scrollArea_7.setStyleSheet(u"background-color:#fff;")
        self.scrollArea_7.setWidgetResizable(True)
        self.scrollAreaWidgetContents_7 = QWidget()
        self.scrollAreaWidgetContents_7.setObjectName(u"scrollAreaWidgetContents_7")
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 411, 151))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 79, 32))
...
"}")
        ...
        self.scrollArea_4.setStyleSheet(u"background-color:#fff;")
...
"}")
        ...
        self.label_10.setGeometry(QRect(80, 370, 371, 31))
        self.label_10.setFont(font3)
        self.new_reminder_threshold_lineEdit = QLineEdit(self.scrollAreaWidgetContents_2)
        self.new_reminder_threshold_lineEdit.setObjectName(u"new_reminder_threshold_lineEdit")
        self.new_reminder_threshold_lineEdit.setGeometry(QRect(50, 440, 31, 21))
        self.label_11 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(50, 410, 131, 21))
        self.label_11.setStyleSheet(u"color: black;")
        self.label_12 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(90, 440, 61, 21))
        self.setting_budget_warning_label = QLabel(self.scrollAreaWidgetContents_2)
        self.setting_budget_warning_label.setObjectName(u"setting_budget_warning_label")
        self.setting_budget_warning_label.setGeometry(QRect(140, 500, 241, 21))
        self.setting_budget_warning_label.setStyleSheet(u"color: red;")
        self.label_13 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(50, 470, 141, 21))
        self.label_13.setStyleSheet(u"color: black;")
        self.new_reminder_threshold2_lineEdit = QLineEdit(self.scrollAreaWidgetContents_2)
        self.new_reminder_threshold2_lineEdit.setObjectName(u"new_reminder_threshold2_lineEdit")
        self.new_reminder_threshold2_lineEdit.setGeometry(QRect(50, 500, 31, 21))
        self.label_14 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(90, 500, 61, 21))
        self.setting_budget_warning_label_2 = QLabel(self.scrollAreaWidgetContents_2)
        self.setting_budget_warning_label_2.setObjectName(u"setting_budget_warning_label_2")
        self.setting_budget_warning_label_2.setGeometry(QRect(140, 440, 241, 21))
        self.setting_budget_warning_label_2.setStyleSheet(u"color: red;")
        self.current_reminder_threshold_label = QLabel(self.scrollAreaWidgetContents_2)
        self.current_reminder_threshold_label.setObjectName(u"current_reminder_threshold_label")
        self.current_reminder_threshold_label.setGeometry(QRect(190, 410, 101, 21))
        self.current_reminder_threshold2_label = QLabel(self.scrollAreaWidgetContents_2)
        self.current_reminder_threshold2_label.setObjectName(u"current_reminder_threshold2_label")
        self.current_reminder_threshold2_label.setGeometry(QRect(190, 470, 101, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Analysis_btn.setText(QCoreApplication.translate("MainWindow", u"History", None))
        self.MenuButton.setText("")
        self.tab_level.setText(QCoreApplication.translate("MainWindow", u"Overview", None))
        self.categories_total_comboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"Expense", None))
        self.categories_total_comboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Income", None))
        ...
        self.income_lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Filter incomes", None))
        self.income_list_header.setText(QCoreApplication.translate("MainWindow", u"Incomes", None))
        self.add_income_button.setText("")
        self.expense_lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Filter expenses", None))
        self.expense_list_header.setText(QCoreApplication.translate("MainWindow", u"Expenses", None))
        ...
        self.searchHistory_lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Filter histories", None))
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Change Budget Reminder Threshold", None))
        self.new_reminder_threshold_lineEdit.setText("")
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"1st reminder threshold", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"percent", None))
        self.setting_budget_warning_label.setText("")
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"2nd reminder threshold", None))
        self.new_reminder_threshold2_lineEdit.setText("")
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"percent", None))
        self.setting_budget_warning_label_2.setText("")
        self.current_reminder_threshold_label.setText(QCoreApplication.translate("MainWindow", u"(Current: 50%)", None))
        self.current_reminder_threshold2_label.setText(QCoreApplication.translate("MainWindow", u"(Current: 80%)", None))
    # retranslateUi
