...
"}")
        ...
        self.profile_label.setMinimumSize(QSize(70, 70))
        self.profile_label.setMaximumSize(QSize(70, 70))
        self.profile_label.setPixmap(QPixmap(u":/black/icon/White/image.svg"))

        self.gridLayout.addWidget(self.profile_label, 0, 0, 2, 1)
