...
"")
        ...
        self.date_label = QLabel(account_form)
        self.date_label.setObjectName(u"date_label")
        self.date_label.setGeometry(QRect(30, 100, 96, 16))
        self.profile_label = QLabel(account_form)
        self.profile_label.setObjectName(u"profile_label")
        self.profile_label.setGeometry(QRect(220, 20, 100, 100))
        ...
        self.label_3 = QLabel(account_form)
    ...
    def retranslateUi(self, account_form):
        ...
        self.date_label.setText(QCoreApplication.translate("account_form", u"24/4/2022 19:35", None))
        self.profile_label.setText("")
        self.label.setText(QCoreApplication.translate("account_form", u"Created Date:", None))
        self.label_3.setText(QCoreApplication.translate("account_form", u"24/4/2022 19:35", None))
    # retranslateUi
