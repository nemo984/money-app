...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.title_label.setGeometry(QRect(97, 51, 291, 20))
        self.remaining_label = QLabel(Form)
        self.remaining_label.setObjectName(u"remaining_label")
        self.remaining_label.setGeometry(QRect(125, 111, 271, 20))
        ...
        self.start_date_label.setGeometry(QRect(121, 71, 271, 20))
        self.end_date_label = QLabel(Form)
        self.end_date_label.setObjectName(u"end_date_label")
        self.end_date_label.setGeometry(QRect(117, 91, 271, 20))
        ...
        self.label_5.setGeometry(QRect(11, 91, 101, 16))
        self.label_5.setFont(font)
        self.label_6 = QLabel(Form)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(11, 111, 111, 16))
        self.label_6.setFont(font)
        self.label_7 = QLabel(Form)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(10, 130, 81, 16))
        self.label_7.setFont(font)
        self.total_budget = QLabel(Form)
        self.total_budget.setObjectName(u"total_budget")
        self.total_budget.setGeometry(QRect(90, 130, 281, 16))
